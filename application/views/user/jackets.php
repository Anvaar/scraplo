...
<select class="dropdown-product selectpicker" name="product-cat" tabindex="-98">
			...
			<option value="jackets" selected="selected"> Jackets</option>
			</select>
...
<div class="row">
  ...
  <?php include'inner-cat.php';?>
			...
			<h5 class="add-title"><a href="ads-details.html">Brand New Hoodie</a></h5>
			...
			<div class="col-sm-7 add-desc-box">
			<div class="add-details">
			<h5 class="add-title"><a href="ads-details.html">Bulk Quantity of Yarns</a></h5>
			...
			<div class="col-sm-7 add-desc-box">
			<div class="add-details">
			<h5 class="add-title"><a href="ads-details.html">New Full Sleeves T-Shirts</a></h5>
			...
			<div class="col-sm-7 add-desc-box">
			<div class="add-details">
			<h5 class="add-title"><a href="ads-details.html">Leather Jacket For Men</a></h5>
